...
| =VIM_NUMBERED_JUMPS=      | Adds the ability to do numbered motions, ie ~10j~ or ~5w~, be wary of large numbers however, as they can freeze up your keyboard. | -402 B            |
...
The tricky part is distinguishing between an inner and outer word, some editors will have a forward word jump go to the end of a word like vim''s ~w~.
